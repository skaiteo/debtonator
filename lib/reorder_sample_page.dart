...
class KnoppReorderPage extends StatefulWidget {
  KnoppReorderPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _KnoppReorderPageState createState() => _KnoppReorderPageState();
}
...
class _KnoppReorderPageState extends State<KnoppReorderPage> {
  List<ItemData> _items;
  _KnoppReorderPageState() {
    _items = List();
    for (int i = 0; i < 500; ++i) {
